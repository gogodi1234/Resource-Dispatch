...
const FilterBar: React.FC<FilterBarProps> = ({ 
  ...
  return (
    <div style={{ 
      display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap', backgroundColor: '#fff',
      padding: '1rem 1.5rem', borderRadius: '12px', border: '1px solid #e5e7eb', marginBottom: '1.5rem'
    }}>
      ...
      <button
        onClick={() => { setFilters({ countries: [], categories: [], statuses: [] }); }}
