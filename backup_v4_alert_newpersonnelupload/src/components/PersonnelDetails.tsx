        ...
        <div style={{ marginBottom: '0.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
            {assignedProjects.length > 0 ? assignedProjects.map(p => {
              ...
              const colors = getStatusStyle(p.status);
                ...
                <div key={p.id} style={{ padding: '0.75rem 1rem', backgroundColor: '#fff', border: '1px solid #E2E8F0', borderRadius: '10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '2px' }}>
                      ...
                      {showTag && (
                        <span style={{ fontSize: '0.6rem', fontWeight: 900, padding: '2px 6px', borderRadius: '4px', textTransform: 'uppercase', backgroundColor: colors.bg, color: colors.text }}>
                          {p.status}
                        </span>
                      )}
                    </div>
                  ...
                  <button 
                    ...
                    style={{ border: 'none', background: '#FEE2E2', color: '#EF4444', padding: '4px 8px', borderRadius: '6px', fontSize: '0.7rem', fontWeight: 700, cursor: 'pointer', marginLeft: '8px' }}
                  >
                    Unassign
                  </button>
                </div>
